...
public class Messages {
    ...
    /**
     * Formats the {@code classToFormat} for display to the user.
     */
    public static String format(seedu.address.model.classes.Class classToFormat) {
        final StringBuilder builder = new StringBuilder();
        builder.append(classToFormat.getClassName());
        return builder.toString();
    }
